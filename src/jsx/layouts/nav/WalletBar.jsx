...
import OrdersAreaChart from '../../elements/OrdersAreaChart';
import ProfitAreaChart from '../../elements/ProfitAreaChart';
import WelletSidePieChart from '../../elements/WelletSidePieChart';


const detailsBlog = [
    {color:'#13C28F', name:'Income', percent:'30',},
    {color:'#FD5353', name:'Expense',percent:'60',},
    {color:'#EEEEEE', name:'Unknown',percent:'10',},
];

const WalletBar = () => {        
    return (
        <>
            <div className={`wallet-bar dz-scroll `}                
                id="wallet-bar"                
            >	
                <div className="row ">                    
                            ...
                            <div className="card-body pb-2">
                                ...
                                {detailsBlog.map((item, i)=>(
                                    <div className="d-flex align-items-center justify-content-between mb-3"  key={i}>
                                        ...
                                        <span>{item.name}</span>
                                        <h6 className="ms-auto font-w700 mb-0">{item.percent}%</h6>
                                    </div>
                                ))}                                
                            </div>

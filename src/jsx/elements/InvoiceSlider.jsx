...
const swiperData = [
    {title:'Completed', number:'3932', color:'primary', icon:SVGICON.InvoiceIcon1},
    {title:'Sent', number:'1932', color:'success', icon:SVGICON.InvoiceIcon2},
    {title:'Unpaid', number:'2932', color:'pink', icon:SVGICON.InvoiceIcon3},
    {title:'Pending', number:'3032', color:'secondary', icon:SVGICON.InvoiceIcon4}
];
                        ...
                        <div className="card card-box blue">
                            ...
                            <div className="card-body p-4  d-flex align-items-center justify-content-between ">
                                <div className="d-flex align-items-center">
                                    <div className={`icon-box icon-box-lg me-2 bg-${item.color}`}>
                                        {item.icon}                                        
                                    </div>
                                    <div>
                                        <h4 className="fs-15 font-w600 mb-0">Invoice<br />{item.title}</h4>
                                    </div>
                                </div>	
                                <div  className="chart-num">
                                    <h2 className="font-w600 mb-0 fs-28 counter_up">

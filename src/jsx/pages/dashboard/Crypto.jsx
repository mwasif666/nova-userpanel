...
import CryptoSlider from '../../elements/CryptoSlider';
import { Dropdown } from 'react-bootstrap';
import { SVGICON } from '../../constant/theme';
import MarketChart from '../../elements/MarketChart';


const marketBlog = [
    {title:'LTC/Year', icon:'1', color:'', bg:'bg-success'},
    {title:'BTC/Year', icon:'2', color:'yellow', bg:'bg-warning'},
    {title:'ETH/Year', icon:'3', color:'blue',bg:'bg-primary' },
    {title:'RIP/Year', icon:'4', color:'', bg:'bg-secondary'},
];
        ...
        <>
            <div className="row">
                <div className="col-xl-12">                                            
                    <MainTitle parent="Dashboard" children="Crypto"/>                        
                </div>                                        
                            ...
                            <div className="card market-previews">
                                ...
                                <div className="card-body pt-0 px-0">
                                    {marketBlog.map((item, i)=>(
                                        <div className={`previews-info ${item.color}`} key={i}>
                                            <div className="pre-icon">
                                                <span className={`icon-box ${item.bg} me-2`}>  
                                                    {
                                                        item.icon === '1' ? 
                            ...
                            <div className="card exchange">
                                ...
                                <div className="card-body pt-0">
                                    <div className="selling">
                                        ...
                                        <div className="form_exchange" >
                                            <div className="input_exchange">
                                                <input type="text" className="input-select" placeholder="Sell" />
                                            </div>
                                    ...
                                    <div className="selling">
                                        ...
                                        <div className="form_exchange" >
                                            <div className="input_exchange">
                                                <input type="text" className="input-select" placeholder="Buy" />
                                            </div>
                                            <div className="crypto-select">
                                                <SelectPicker
                                                    className='select-data'

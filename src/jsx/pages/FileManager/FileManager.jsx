...
const libraryList = [
    {id: 0, title:'Project 01', svgIocn:SVGICON.projectSvg1, },
    {id: 1, title:'Project 02', svgIocn:SVGICON.projectSvg1, },
    {id: 2, title:'Project 03', svgIocn:SVGICON.projectSvg1, },
    {id: 3, title:'Project 04', svgIocn:SVGICON.projectSvg1, },
    {id: 4, title:'Project 04', svgIocn:SVGICON.projectSvg1, },
    {id: 5, title:'list.txt', svgIocn:SVGICON.projectSvg2, },
    {id: 6, title:'theme.mp3', svgIocn:SVGICON.projectSvg3, },
    {id: 7, title:'preview.mp4', svgIocn:SVGICON.projectSvg4, },
    {id: 8, title:'profile.jpg', image:IMAGES.mediaimg1, },
    {id: 9, title:'team.jpg', image:IMAGES.mediaimg2, },
    {id: 10,title:'profile2.png', image:IMAGES.mediaimg3, },
    {id: 11,title:'profile3.png', image:IMAGES.mediaimg4, },
];
            ...
            <div className="card p-0 rounded-0 file_area mb-0">
                <div className="row gx-0">
                    <div className="col-xl-2 col-xxl-3 col-lg-3 col-md-4">
                        <div className="file-manager email-left-box border-end mb-0 dz-scroll" id="email-left">
                            <div className="p-0">
                                <Link to={"/email-compose"} className="btn text-white btn-block"><i className="fa-solid fa-plus me-3" />Upload</Link>
                            </div>
                            <div className="mail-list rounded ">
                                <Link to={"/email-inbox"} className="list-group-item active"><i className="fa-regular fa-envelope align-middle" />Inbox <span className="badge badge-secondary badge-sm float-end rounded">2</span> </Link>
                    ...
                    <div className="col-xl-10 col-xxl-9 col-lg-9 col-md-8">                       
                        <div className="row  gx-0">
                            ...
                            <div className="col-xl-12">
                                <div as="ul" className={`folder-structure dz-scroll ${toggle ? 'grid' : ''}`}>
                                            ...
                                            <div className="file-list" >
                                                ...
                                                <div className="dz-info">
                                                    <Link to={"#"}>
                                                        ...
                                                        <span>3 Items March 27th, 2024  04:56 AM - 10.0 MB</span>
                                                    </Link>	
                                                </div>
                                            </div>
                                        </li>

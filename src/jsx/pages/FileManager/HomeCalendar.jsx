...
import FileManagerCalendar from '../../elements/Calendar/FileManagerCalendar';
                        ...
                        <div className="col-xl-12">
                            <div className="page-titles">
                                ...
                                <div className="mt-sm-0 mt-2">
                                    <button className="btn btn-primary light me-1">Today<span>(14)</span></button>
                                    <button className="btn btn-primary ms-1" onClick={() => childRef.current.openModal()}> 
                                        {SVGICON.PlusSign} New Schedule 
                                    </button>
                                </div>
